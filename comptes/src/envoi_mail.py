...
# =====================================================
class RecuperationMDP(QtWidgets.QDialog, GUI_MDP.Ui_Dialog):
    """
...
class EnvoiMail(object):
    ...
    def __init__(self, expediteur, destinataire, liste_des_fichiers_a_envoyer):
        ...
        self._message_du_mail = ("Ce mail possède, en pièce jointe, un fichier contenant les données pour mes comptes.\n"
                                 "\nCe mail a été généré automatiquement par l'application des comptes.")
    ...
    def configurer_les_elements_du_mail(self):
        ...
        # Partie qui gère l'envoi de pièce jointe
