...
class ModeleEpargnes(QtCore.QAbstractTableModel):
    ...
    def __init__(self, donnees, parent=None):
        ...
        self._liste_des_valeurs_a_diviser = ["Taxe_habitation", "Taxe_fonciere"]
        self._somme_des_epargnes = 0.0
    ...
    # ===========================
    @property
    def somme_des_epargnes(self):
        """
            Propriété qui permet de récupérer la somme des épargnes
        """
        
        return self._somme_des_epargnes

    # =======================================
    def calculer_la_somme_des_epargnes(self):
        """
            Méthode qui permet de calculer la somme des épargnes
        """
        
        self._somme_des_epargnes = sum([ float(element["montant"]) for indice, element in enumerate(self._donnees) ])
    ...
    def data(self, index, role=QtCore.Qt.DisplayRole):
        ...
        # L'index est valide
            ...
            # Si le rôle correspond à de l'affichage
                ...
                if index.column() == 0:
                # Si l'on se situe sur la première colonne on récupère le titre
